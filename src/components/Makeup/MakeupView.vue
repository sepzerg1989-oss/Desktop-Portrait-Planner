<template>
  <div class="space-y-10">
    ...
    <div>
      ...
      <!-- 描述 -->
      <div v-if="makeup?.description" class="p-6 bg-morandi-canvas/30 rounded-sm border border-morandi-border/20 text-xs text-morandi-text/80 leading-relaxed font-sans whitespace-pre-wrap">
        {{ makeup.description }}
      </div>
    </div>
